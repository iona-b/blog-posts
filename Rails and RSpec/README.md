...
Great! We now have a more efficient recursive solution that avoids redoing the same work. This means that, when implemented correctly, our runtime becomes linear rather than exponential, which is a huge improvement.
...
4. "[What Is the Fibonacci Sequence?](https://www.livescience.com/37470-fibonacci-sequence.html)", Tia Ghose on Live Science, Accessed November 20, 2020